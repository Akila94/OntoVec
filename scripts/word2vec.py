...
from scripts.PreprocessorNew import preprocess

path_to_file_to_process = "../data/t.txt"
...
list_to_train = preprocess(path_to_file_to_process)
...
if not os.path.isfile(path_to_trained_model):
    ...
    print(model1.most_similar("investigate".lower()))
